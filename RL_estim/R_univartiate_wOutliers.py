# from https://github.com/juliana-du/Covid-R-estim/blob/main/include/estim/Rt_UnivariateOutliers.py
...
from RL_estim.optim_tools.Rt_Joint_graph import Rt_Jgraph
