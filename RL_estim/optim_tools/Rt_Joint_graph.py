# from https://github.com/juliana-du/Covid-R-estim/blob/main/include/optim_tools/Rt_Joint_graph.py
...
from RL_estim.optim_tools import CP_covid_5_outlier_graph as cp5g
