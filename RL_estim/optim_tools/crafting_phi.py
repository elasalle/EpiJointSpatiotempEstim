# from https://github.com/juliana-du/Covid-R-estim/blob/main/include/optim_tools/crafting_phi.py
# downloaded in 2025-03

# modification by Etienne Lasalle:
# - modif1, 2025-03: deal with timestamps equals to None
...
def buildZPhi(timestamps, ZData, Phi):
    ...
    if timestamps is not None: # modif1
