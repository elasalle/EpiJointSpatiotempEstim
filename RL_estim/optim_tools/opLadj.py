# from https://github.com/juliana-du/Covid-R-estim/blob/main/include/optim_tools/opLadj.py
# downloaded in 2025-03

# modifications by Etienne Lasalle:
# - modif1, 2025-03: change the dot product into vector product in numpy



import numpy as np
from RL_estim.optim_tools.conversion_pymat import struct
