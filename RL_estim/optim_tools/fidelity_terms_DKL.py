# from https://github.com/juliana-du/Covid-R-estim/blob/main/include/optim_tools/fidelity_terms_DKL.py
# downloaded in 2025-03

# modifications by Etienne Lasalle:
# - modif1, 2025-03: for x to be of type float
# - modif2, 2025-03: compute prox in one line
...
def prox_DKL_no_outlier(x, data, alpha, gamma):
    ...
    """
    x = x.astype('float64') # modif1
    prox = (x - gamma * alpha + np.sqrt(np.abs(x - gamma * alpha) ** 2 + 4 * gamma * data)) / 2 # modif2
