# from https://github.com/juliana-du/Covid-R-estim/blob/main/include/estim/Rt_Gamma.py
# downloaded in 2025-03

# modifications by Etienne Lasalle:
# - modif1, 2025-07: chnage defaut setting 
...
def Rt_Gamma(data, tau=7, display=False, options=None): # modif1
    """
